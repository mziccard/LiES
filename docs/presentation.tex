...
\title[LiES]{Linear Equations Systems Solver} % The short title appears at the bottom of every slide, the full title is only on the title page
...
{
Universita' degli Studi di Padova\\[10mm] % Your institution for the title page
{\large Marco Ziccardi\\
Sebastiano Gottardo\\[10mm]}
}
...
%\begin{frame}
%\frametitle{Performance assessment: detection}
%
%\begin{figure}
%\centering
